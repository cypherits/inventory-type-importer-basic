...
<div class="container p-5 about_us_container invoice_company bg-white">
    <div class="row">
        ...
        <div class="col-md-6 col-xl-4 col-xxl-3 pr-0 mt-3 mt-xl-0">
            <h1 class="invoice_title">Invoice Details</h1>
            <table class="table invoice_details">
                <tbody>
                    <tr>
                        <td>Invoice Number <span>:</span></td>
                        <td><?= $invoice_id ?></td>
                    </tr>
                    <tr>
                        <td>Vat Reg No <span>:</span></td>
                        <td><?= $vat_reg_no ?></td>
                    </tr>
                    <tr>
                        <td>Invoice Date <span>:</span></td>
        ...
        <div class="col-md-5 pl-0">
            <h1 class="invoice_title">Other Info</h1>
            <table class="table invoice_to invoice_details">
                <tbody>
                    <tr>
                        <td>Executive Name<span>:</span></td>
                        <td><?= $executive_name ?></td>
                    </tr>
                    <tr>
                        <td>Transport Method<span>:</span></td>
                        <td><?= $transport_method ?></td>
                    </tr>
                    <tr>
