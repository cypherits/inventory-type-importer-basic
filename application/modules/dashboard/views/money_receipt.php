...
<div class="container p-5 about_us_container invoice_company bg-white">
    <div class="row">
        ...
        <div class="col-md-6 col-xl-8 col-xxl-9 pl-0">
            <h1 class="invoice_title">Money Receipt To</h1><br>
        ...
        <div class="col-md-6 col-xl-4 col-xxl-3 pr-0 mt-3 mt-xl-0">
            <h1 class="invoice_title">Details</h1>
            ...
            <table class="table text-center">
                ...
                <tbody>
                    ...
                    foreach ($items as $item) {
                        ?>
                        <tr>
                            <td><?= get_product_by_id($item->particular)['product_name'].' - '.get_product_by_id($item->particular)['size'] ?></td>
                            <td><?= $item->remark ?></td>
                            <td><?= $item->ammount ?></td>
                        </tr>
                        <?php
        ...
        <div class="col-md-5 pl-0">
            ...
            <table class="table invoice_to invoice_details">
                <tbody>
                    <tr>
                        <td>Paid By<span>:</span></td>
                        <td><?= ($payment_type == 'cash')?'Cash':'Cheque' ?></td>
                    </tr>
