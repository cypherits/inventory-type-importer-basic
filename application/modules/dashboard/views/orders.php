...
<div class="container p-5 about_us_container invoice_company bg-white">
    <div class="row">
        <div class="col-12 invoice_company_info pt-4 pb-4 mb-5">
            <div class="row">
                ...
                <div class="col-md-3 offset-md-5 col-12 align-self-center text-center">
                    <h1>Order Requisition</h1>                          
                </div>                        
            </div>
        </div>
        <div class="col-md-6 col-xl-8 col-xxl-9 pl-0">
            <h1 class="invoice_title">Order To</h1><br>
        ...
        <div class="col-md-6 col-xl-4 col-xxl-3 pr-0 mt-3 mt-xl-0">
            <h1 class="invoice_title">Order Details</h1>
            <table class="table invoice_details">
                <tbody>
                    <tr>
                        <td>Order Number <span>:</span></td>
                        <td><?= $id ?></td>
                    </tr>
                    <tr>
                        <td>Visit Date <span>:</span></td>
                        <td><?= date('d M Y', strtotime($date_of_visit)) ?></td>
                    </tr>
                    <tr>
                        <td>Order Date <span>:</span></td>
        ...
        <div class="col-md-5 pl-0">
            <h1 class="invoice_title">Payment Info</h1>
            <table class="table invoice_to invoice_details">
                <tbody>
                    <?php if($payment_type == 'chq'){ ?>
                    <tr>
                        <td>Bank Name<span>:</span></td>
                        <td><?= $bank_name ?></td>
                    </tr>
                    <tr>
                        <td>Cheque No<span>:</span></td>
                        <td><?= $chq_no ?></td>
                    </tr>
                    <tr>
                        <td>Cheque Amount<span>:</span></td>
                        <td><?= $chq_ammount ?></td>
                    </tr>
                    <?php }else{ ?>
                    <tr>
