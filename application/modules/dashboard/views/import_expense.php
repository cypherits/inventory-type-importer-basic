...
<div class="container p-5 about_us_container invoice_company bg-white">
    <div class="row">
        ...
        <div class="col-md-6 col-xl-8 col-xxl-9 pl-0">
            <h1 class="invoice_title">Invoice To</h1><br>
            <table class="table invoice_to">
                <tbody>
                    <tr>
                        <td>Product Name <span>:</span></td>
                        <td>
                            <?= get_product_by_id($products_id)['product_name'] ?>
                        </td>
                        <td>&nbsp;</td>
                        <td>
                            &nbsp;
                    ...
                    <tr>
                        <td>Product Size <span>:</span></td>
                        <td>
                            <?= get_product_by_id($products_id)['size'] ?>
                        </td>
                        <td>&nbsp;</td>
                        <td></td>
                    </tr> 
        ...
        <div class="col-lg-12 mt-4 pl-0 pr-0 payment_info travel_details">
            ...
            <table class="table text-center">
                ...
                <tbody>
                    <tr>
                        <td>LC Opening Payment To Bank</td>
                        <td><?=$lc_opening_payment_to_bank?></td>
                    </tr>  
                    <tr>
                        <td>Bank Charges</td>
                        <td><?=$bank_charges?></td>
                    ...
                    <tr>
                        <td>Payment To Exporter</td>
                        <td><?=$payment_to_exporter?></td>
                    </tr> 
                    <tr>
                        <td>Customs Duty</td>
                        <td><?=$customs_duty?></td>
                    ...
                    <tr>
                        <td>Others Payment</td>
                        <td><?=$others_payment?></td>
                    </tr> 
                    <tr>
                        <td>CNF Bill</td>
                        <td><?=$cnf_bill?></td>
            ...
            <div class="col-md-4 col-xl-3 offset-md-8 offset-xl-9 col-lg-4 offset-lg-8 pr-0 total_charge">
                <table class="table text-center">
                    <tbody>
                        <tr>
                            <td>Total Expense<span>:</span></td>
                            <td><?= $total_expense ?></td>
                        </tr>    
                        <tr>
                            <td>Expense Per Unit<span>:</span></td>
                            <td><?= $unit_cost ?></td>
                        </tr>                               
                    </tbody>
                </table>
